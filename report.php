...
<head>
    ...
    <!-- Title -->
    <title>ExploiterID Bounty - Report</title>
        ...
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-end justify-content-center">
                <div class="hero-slide-content text-center">
                    <h2 style="margin-top: -80%;">Welcome To Report ExploiterID Programs</h2>
                    <h4>Report are a place for you to see reports from both confirmed and pending users</h4>
     ...
     <div class="table-responsive table--no-card m-b-40">
         <table class="example table table-borderless table-striped table-earning">
            ...
            <tbody>
                ...
                $resultReport = mysqli_query($link, "SELECT * FROM bugs WHERE status = 'confirm' ORDER BY id DESC LIMIT 250");
...
<div class="section-heading text-center">
    <p>Latest Bugs Report</p>
    <h2>This is latest bugs report that has not been <b style="color: red;">confirmed (pending)</b></h2>
</div>
<div class="row">
    <div class="col-lg-12" style="padding: 30px;">
     <div class="table-responsive table--no-card m-b-40">
         <table class="example table table-borderless table-striped table-earning">
            ...
            <tbody>
                ...
                $resultReport = mysqli_query($link, "SELECT * FROM bugs WHERE status = 'pending' ORDER BY id DESC LIMIT 250");
                while ($rowReport = mysqli_fetch_array($resultReport)) {
                 ...
                 <tr>
                    ...
                    <td><?= $rowReport['summary']; ?></td>
                    <td><?php if ($rowReport['vulnerbility'] === ''): ?>
                        <p style="color: red;">Pending</p>
                    <?php endif ?></td>
                    <td class="text-right"><?= $rowReport['date']; ?></td>
                </tr>
