    ...
    //Explod
       ...
       <?php if ($row['status'] === 'confirm'): ?>
        ...
        <head>
            ...
            <meta name="description" content="<?= $rowId['credit'] ?> the latest report with the title <?= $rowId['summary']; ?>">
            <title><?= $rowId['summary']; ?></title>
                ...
                <div class="hero-slides owl-carousel">
                    ...
                    <div class="single-hero-slide d-flex align-items-end justify-content-center">
                        <div class="hero-slide-content text-center">
                            <h2 style="margin-top: -80%;"><?= $rowId['summary']; ?></h2>
                            <h4><?= $rowId['credit'] ?> the latest report with the title <?= $rowId['summary']; ?></h4>
